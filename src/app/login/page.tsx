    ...
    <div className="min-h-screen flex items-center justify-center px-6" style={{ background: 'var(--bg-page)' }}>
      <div className="w-full max-w-sm">
        ...
        <div className="flex flex-col" style={{ gap: 'var(--space-3)' }}>
          <button className="btn-outline" style={{ width: '100%', height: 42 }}>
        ...
        <form className="flex flex-col" style={{ gap: 'var(--space-3)' }}>
          <input
            type="email"
          ...
          />
          <button type="submit" className="btn-primary" style={{ width: '100%', height: 42 }}>
            Continue with email
          </button>
        </form>
